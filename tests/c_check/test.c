...
START_TEST(test_my_str_from_cstr)
{
#line 47
    my_str_t str;
    my_str_create(&str, 0);
...
START_TEST(test_my_str_capacity)
{
#line 67
    my_str_t str;
    my_str_create(&str, 0);
...
START_TEST(test_my_str_get_cstr)
{
#line 113
...
int main(void)
{
    ...
    tcase_add_test(tc1_1, test_my_str_create);
    tcase_add_test(tc1_1, test_my_str_from_cstr);
    tcase_add_test(tc1_1, test_my_str_size);
    tcase_add_test(tc1_1, test_my_str_capacity);
    tcase_add_test(tc1_1, test_my_str_empty);
    tcase_add_test(tc1_1, test_my_str_getc);
    tcase_add_test(tc1_1, test_my_str_putc);
    tcase_add_test(tc1_1, test_my_str_get_cstr);
    tcase_add_test(tc1_1, test_my_str_pushback);
    tcase_add_test(tc1_1, test_my_str_popback);
    tcase_add_test(tc1_1, test_my_str_copy);
    tcase_add_test(tc1_1, test_my_str_insert_c);
    tcase_add_test(tc1_1, test_my_str_insert);
    tcase_add_test(tc1_1, test_my_str_insert_cstr);
    tcase_add_test(tc1_1, test_my_str_append);
    tcase_add_test(tc1_1, test_my_str_append_cstr);
    tcase_add_test(tc1_1, test_my_str_substr);
    tcase_add_test(tc1_1, test_my_str_substr_cstr);
    tcase_add_test(tc1_1, test_my_str_reserve);
    tcase_add_test(tc1_1, test_my_str_shrink_to_fit);
    tcase_add_test(tc1_1, test_my_str_resize);
    tcase_add_test(tc1_1, test_my_str_find);
    tcase_add_test(tc1_1, test_my_str_cmp);
    tcase_add_test(tc1_1, test_my_str_cmp_cstr);
    tcase_add_test(tc1_1, test_my_str_find_c);
    tcase_add_test(tc1_1, test_my_str_find_if);
    tcase_add_test(tc1_1, test_my_str_read_file);
    tcase_add_test(tc1_1, test_my_str_write_file);
    tcase_add_test(tc1_1, test_my_str_read_file_delim);
